/**
 * This is the SquiggleLeft class, which handles the Tetrimino type, rotation and position
 * of a left squiggle piece.
 *
 ...
 */
public class SquiggleLeft implements Tetromino{
    private int posX;
    private int posY;
    private int[][] blocks;
